const templates = {
    ...
    laPage6LotOnly: {
        id: 'laPage6LotOnly',
        displayString: 'LA Page 6 Clause - Lot only',
        containerDivId: 'laPage6LotOnlyDiv',
        clause: 'The Borrower/s shall be required to execute an Affidavit of Consent to Mortgage Family Home in the event the family residence is constructed on the vacant lot mortgage w/ Union Bank. Non-compliance in the submission of this Affidavit shall be considered an Event of Default under this Agreement.'
    },
}
